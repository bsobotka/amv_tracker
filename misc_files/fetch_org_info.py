...
def download_data(url):
	"""
	:param url: a-m-v.org video profile URL to parse
	...
	out_dict = {
		'Editor username': ed_name,
		'Additional editors': addl_ed,
		'Studio': studio,
		'Video title': vid_title,
		'Release date': [rel_date_year, rel_date_mo, rel_date_day],
		'Anime': anime_all_fixed,
		...
		'YouTube URL': yt_link,
		'amvnews URL': amvnews_link,
		'Other URL': other_link,
		'Editor profile URL': editor_profile_link
	}
